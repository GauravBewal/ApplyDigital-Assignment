...
from testData.registration_data import initialize_registration_data
...
class TestPlaceOrder(Base):
    ...
    def test_place_order(self, page):
        ...
        po.enter_quantity(quantity=str(qty))
        log.info("Quantity entered - "+str(qty))
